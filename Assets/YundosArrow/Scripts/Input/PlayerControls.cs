...
namespace Assets.YundosArrow.Scripts.Input
{
    ...
    ""controlSchemes"": []
        ...
        private List<ISlimeRepoActions> m_SlimeRepoActionsCallbackInterfaces = new List<ISlimeRepoActions>();
        ...
        public struct SlimeRepoActions
        {
            ...
            public void AddCallbacks(ISlimeRepoActions instance)
            {
                if (instance == null || m_Wrapper.m_SlimeRepoActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_SlimeRepoActionsCallbackInterfaces.Add(instance);
            ...
            private void UnregisterCallbacks(ISlimeRepoActions instance)
            {
                @Purple.started -= instance.OnPurple;
                @Purple.performed -= instance.OnPurple;
                @Purple.canceled -= instance.OnPurple;
            ...
            public void RemoveCallbacks(ISlimeRepoActions instance)
            {
                if (m_Wrapper.m_SlimeRepoActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(ISlimeRepoActions instance)
            {
                foreach (var item in m_Wrapper.m_SlimeRepoActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_SlimeRepoActionsCallbackInterfaces.Clear();
                AddCallbacks(instance);
            }
        }
